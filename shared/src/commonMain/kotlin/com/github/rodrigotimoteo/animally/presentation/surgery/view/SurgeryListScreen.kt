...
/**
 * Surgery list embedded in the patient detail screen.
 *
 * @param viewModel The [SurgeryListViewModel] for this screen.
 * @param modifier Optional modifier.
 */
@Composable
fun SurgeryListScreen(
    viewModel: SurgeryListViewModel,
...
@Composable
private fun SurgeryListContent(
    uiState: SurgeryListUiState,
    modifier: Modifier,
    onAddClick: () -> Unit,
        ...
        when {
            ...
            uiState.records.isEmpty() ->
                Box(
                    ...
                    Text("No surgeries yet", style = MaterialTheme.typography.bodyLarge)
                }
            else -> SurgeryList(uiState.records, onEditClick)
        }
    }
}
...
private fun SurgeryList(
    records: List<Surgery>,
    onEditClick: (Long) -> Unit,
) {
    LazyColumn(Modifier.fillMaxSize()) {
        items(records, key = { it.id }) { record ->
            SurgeryCard(record, onEditClick)
        }
    }
}

@Composable
private fun SurgeryCard(
    record: Surgery,
    onEditClick: (Long) -> Unit,
) {
